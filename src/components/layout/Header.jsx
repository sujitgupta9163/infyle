    ...
    <header className="sticky top-0 z-30 flex items-center justify-between bg-white/80 dark:bg-[#080b14]/80 px-4 py-5 backdrop-blur-xl border-b border-gray-200 dark:border-gray-800/50 transition-all">
      ...
      <div className="ml-4 flex items-center gap-6">
        <button 
          ...
          className="relative text-gray-500 hover:text-indigo-600 dark:text-gray-400 dark:hover:text-white transition-colors"
        >
        ...
        <div className="flex items-center gap-3 cursor-pointer group hover:bg-black/5 dark:hover:bg-white/5 p-1.5 rounded-full transition-all">
          ...
          <span className="hidden text-sm font-semibold text-gray-700 dark:text-gray-200 group-hover:text-gray-900 dark:group-hover:text-white sm:block transition-colors">Sujit</span>
          <span className="text-gray-400 dark:text-gray-500 text-xs hidden sm:block group-hover:text-gray-600 dark:group-hover:text-gray-300">▼</span>
        </div>
      </div>
    </header>
  );
